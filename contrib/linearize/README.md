# Linearize
Construct a linear, no-fork, best version of the VillageCoin blockchain. The scripts
...
JSON-RPC server. Running `dashd` or `village-qt -server` will be sufficient.
