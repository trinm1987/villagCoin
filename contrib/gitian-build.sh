...
VERSION=
commit=false
url=https://github.com/dashpay/village
proc=2
mem=2000
lxc=true
docker=false
...
Run this script from the directory containing the village, gitian-builder, gitian.sigs, and village-detached-sigs.
...
-u|--url	Specify the URL of the repository. Default is https://github.com/dashpay/village
...
then
	...
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit village=${COMMIT} --url village=${url} ../village/contrib/gitian-descriptors/gitian-linux.yml
	    ./bin/gsign -p "$signProg" --signer "$SIGNER" --release ${VERSION}-linux --destination ../gitian.sigs/ ../village/contrib/gitian-descriptors/gitian-linux.yml
	...
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit village=${COMMIT} --url village=${url} ../village/contrib/gitian-descriptors/gitian-win.yml
	    ./bin/gsign -p "$signProg" --signer "$SIGNER" --release ${VERSION}-win-unsigned --destination ../gitian.sigs/ ../village/contrib/gitian-descriptors/gitian-win.yml
	...
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit village=${COMMIT} --url village=${url} ../village/contrib/gitian-descriptors/gitian-osx.yml
	    ./bin/gsign -p "$signProg" --signer "$SIGNER" --release ${VERSION}-osx-unsigned --destination ../gitian.sigs/ ../village/contrib/gitian-descriptors/gitian-osx.yml
...
then
	...
	then
	    ...
	    echo ""
	    ./bin/gbuild -i --commit signature=${COMMIT} ../village/contrib/gitian-descriptors/gitian-win-signer.yml
	    ./bin/gsign -p "$signProg" --signer "$SIGNER" --release ${VERSION}-win-signed --destination ../gitian.sigs/ ../village/contrib/gitian-descriptors/gitian-win-signer.yml
	...
	then
	    ...
	    echo ""
	    ./bin/gbuild -i --commit signature=${COMMIT} ../village/contrib/gitian-descriptors/gitian-osx-signer.yml
	    ./bin/gsign -p "$signProg" --signer "$SIGNER" --release ${VERSION}-osx-signed --destination ../gitian.sigs/ ../village/contrib/gitian-descriptors/gitian-osx-signer.yml
