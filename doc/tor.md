TOR SUPPORT IN DEED CORE
=======================

It is possible to run VillageCoin Core as a Tor hidden service, and connect to such services.
...
1. Run VillageCoin Core behind a Tor proxy
----------------------------------

The first step is running VillageCoin Core behind a Tor proxy. This will already make all
...
2. Run a VillageCoin Core hidden server
-------------------------------
...
your dashd's P2P listen port (9999 by default).
	...
	-externalip=X   You can tell VillageCoin Core about its publicly reachable address using
...
3. List of known VillageCoin Core Tor relays
------------------------------------
...
VillageCoin Core has been updated to make use of this.

This means that if Tor is running (and proper authentication has been configured),
VillageCoin Core automatically creates a hidden service to listen on. This will positively 
affect the number of available .onion nodes.

This new feature is enabled by default if VillageCoin Core is listening (`-listen`), and
