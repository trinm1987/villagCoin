    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("DEED-light"), QVariant("light"));
    ui->theme->addItem(QString("DEED-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("DEED-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("DEED-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("DEED-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("DEED-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("DEED-traditional"), QVariant("trad"));
