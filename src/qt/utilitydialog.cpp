    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  village-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the VillageCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 DEED, 0.1 DEED, 1 DEED and 10 DEED -- sort of like the paper money you use every day.</li> \
