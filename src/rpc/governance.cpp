...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in village.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("village.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    ...
    { "village",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "village",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "village",               "gobject",                &gobject,                true,  {} },
    { "village",               "voteraw",                &voteraw,                true,  {} },
